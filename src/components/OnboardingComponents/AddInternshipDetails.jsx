...
const AddInternshipDetails = () => {
  ...
  useEffect(() => {
    ...
    dispatch(
      setSkillDetails({ field: "internshipDetails", value: internshipArray })
    );
            ...
            {internship?.isExpanded && (
              ...
              >
                ...
                >
                  ...
                  <input
                    id={"choose-resume-file-56702" + index}
                    type="file"
                    style={{
                      display: "none",
                      visibility: "hidden",
                  ...
                  <UploadButton
                    handleOnClick={() => {
                      ...
                      handleUploadResumeClick(
                        `choose-resume-file-56702${index}`
                      );
                    }}
